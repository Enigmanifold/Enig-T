function [chosen_R,chosen_T,chosen_phi]=epipole_corrs_to_RT_epi1known(epi2_sph,epi1_sph,p1,p2,ptsnum)
...
% correspondences in image plane, calculate R,T and phi.
    ...
    epi12_sph=[epi1_sph(1),epi1_sph(2),epi2_sph(1),epi2_sph(2)];
    ...
    switch min_reproj_errs_ind
        ...
        case 3
            ...
            switch max([posdepth1,posdepth2])
                    case posdepth1
                        chosen_R=candi_R1;
                        chosen_phi=avg_phi1_alt;
                    case posdepth2
                        chosen_R=candi_R2;
                        chosen_phi=avg_phi2_alt;
            end
            chosen_T=T;
        case 4
            candi_R1=calcR3;
