function lhs_minus_rhs=calc_eta2s_lhsrhs(e1,e2,xi2,p1,p2,p3,p4)
...
% equation of the second component of the second epipole.
    [xi1,eta1]=deal(e1(1),e1(2));
    [xi2,eta2]=deal(e2(1),e2(2));
    [x1,y1]=deal(p1(1),p1(2));
    [x2,y2]=deal(p2(1),p2(2));
    ...
    e2g3De2g4squared=e2g3De2g4^2;
    e1g1squared=e1g1'*e1g1;
    e1g2squared=e1g2'*e1g2;
    e2g3squared=e2g3'*e2g3;
    e2g4squared=e2g4'*e2g4;
    lhs=e1g1De1g2squared*e2g3squared*e2g4squared;
    rhs=e2g3De2g4squared*e1g1squared*e1g2squared;
